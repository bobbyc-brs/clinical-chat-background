...
def run(args):
    ...
    with sd.InputStream(device=1,samplerate=SAMPLE_RATE, channels=CHANNELS, dtype="float32", blocksize=int(SAMPLE_RATE * BLOCK_SECONDS), callback=audio_buffer.callback):
